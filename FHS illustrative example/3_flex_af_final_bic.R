...
fp.res[c(4,15),] <- fp.res[c(4,15),] ^ sds[3]
...
write.csv(fp.fmt[c(2:12,15,16),], 'results//flex_af_mod_revision_bic.csv', row.names=FALSE)
...
write.csv(diffs.fmt, "results//flex_af_diffltr_revision_bic.csv", row.names=FALSE)
