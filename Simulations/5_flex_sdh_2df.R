...
for(k in nstart:nend){
  ...
  tryCatch({fp <- stpm2(Surv(Tstart-55, Tstop-55, ev1) ~ arm, weight=weight.ltrc, data=dat.ltrc, df=3, tvc=list(arm=2), link='PH')
...
write.csv(res, paste0("//restricted//projectnb//conner-thesis//lifetimerisk//simulation//flex//sdhv2_sub55_2df//res_", l, "_", nend, ".csv"), row.names=FALSE)
